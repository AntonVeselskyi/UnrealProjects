...
#define ORIGINAL_FILE_NAME "UE4Editor-UE_LiveTraining.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME UE_LiveTraining
#define DEPRECATED_FORGAME DEPRECATED
#define UE_LIVETRAINING_API DLLEXPORT
